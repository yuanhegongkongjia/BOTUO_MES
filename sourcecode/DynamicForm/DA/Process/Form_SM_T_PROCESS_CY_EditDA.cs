...
{
    public class Form_SM_T_PROCESS_CY_EditDA : CommonBaseDA
    {
        public override string TableName
        {
            get { return "SM_T_PROCESS_CY"; }
        }
        ...
        public override int Update(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Update<SM_T_PROCESS_CY>(newEntity.To<SM_T_PROCESS_CY>());
            }
            message = "保存成功";
        ...
        public override int Insert(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Insert<SM_T_PROCESS_CY>(newEntity.To<SM_T_PROCESS_CY>());
            }
