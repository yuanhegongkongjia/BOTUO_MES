...
{
    public class Form_SM_M_DEFECT_EditDA : CommonBaseDA
    {
        public override string TableName
        {
            get { return "SM_M_DEFECT"; }
        }
        ...
        public override int Update(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Update<SM_M_DEFECT>(newEntity.To<SM_M_DEFECT>());
            }
            message = "保存成功";
        ...
        public override int Insert(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Insert<SM_M_DEFECT>(newEntity.To<SM_M_DEFECT>());
            }
