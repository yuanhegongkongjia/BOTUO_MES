...
{
    public class Form_BT_POWER_MONTH_EditDA : CommonBaseDA
    {
        public override string TableName
        {
            get { return "BT_POWER_MONTH"; }
        }
        ...
        public override int Update(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Insert<BT_POWER_MONTH>(newEntity.To<BT_POWER_MONTH>());
            }
            message = "保存成功";
        ...
        public override int Insert(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Update<BT_POWER_MONTH>(newEntity.To<BT_POWER_MONTH>());
            }
