...
{
    public class Form_BT_BAD_PRODUCT_EditDA : CommonBaseDA
    {
        public override string TableName
        {
            get { return "BT_BAD_PRODUCT"; }
        }
        ...
        public override int Update(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Insert<BT_BAD_PRODUCT>(newEntity.To<BT_BAD_PRODUCT>());
            }
            message = "保存成功";
        ...
        public override int Insert(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Update<BT_BAD_PRODUCT>(newEntity.To<BT_BAD_PRODUCT>());
            }
