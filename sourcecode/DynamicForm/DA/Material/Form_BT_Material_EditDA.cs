...
{
    public class Form_BT_Material_EditDA : CommonBaseDA
    {
        public override string TableName
        {
            get { return "BT_Material"; }
        }
        ...
        public override int Update(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Update<BT_Material>(newEntity.To<BT_Material>());
            }
            message = "保存成功";
        ...
        public override int Insert(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Insert<BT_Material>(newEntity.To<BT_Material>());
            }
