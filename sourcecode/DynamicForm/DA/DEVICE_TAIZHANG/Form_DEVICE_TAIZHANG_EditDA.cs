...
{
    public class Form_DEVICE_TAIZHANG_EditDA : CommonBaseDA
    {
        public override string TableName
        {
            get { return "DEVICE_TAIZHANG"; }
        }
        ...
        {
            return new { DEVICE_ID = entity["DEVICE_ID"] };
        }
        ...
        public override int Update(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Update <DEVICE_TAIZHANG>(newEntity.To<DEVICE_TAIZHANG>());
            }
            message = "保存成功";
        ...
        public override int Insert(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Insert <DEVICE_TAIZHANG>(newEntity.To<DEVICE_TAIZHANG>());
            }
