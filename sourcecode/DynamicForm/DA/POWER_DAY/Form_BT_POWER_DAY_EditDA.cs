...
{
    public class Form_BT_POWER_DAY_EditDA : CommonBaseDA
    {
        public override string TableName
        {
            get { return "BT_POWER_DAY"; }
        }
        ...
        public override int Update(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Insert<BT_POWER_DAY>(newEntity.To<BT_POWER_DAY>());
            }
            message = "保存成功";
        ...
        public override int Insert(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Update<BT_POWER_DAY>(newEntity.To<BT_POWER_DAY>());
            }
