...
{
    public class Form_BT_MachineManage_EditDA : CommonBaseDA
    {
        public override string TableName
        {
            get { return "BT_MachineManage"; }
        }
        ...
        public override int Update(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Insert<BT_MachineManage>(newEntity.To<BT_MachineManage>());
            }
            message = "保存成功";
        ...
        public override int Insert(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Update<BT_MachineManage>(newEntity.To<BT_MachineManage>());
            }
