...
{
    public class Form_BT_MachineAnalyse_EditDA : CommonBaseDA
    {
        public override string TableName
        {
            get { return "BT_MachineAnalyse"; }
        }
        ...
        public override int Update(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Insert<BT_MachineAnalyse>(newEntity.To<BT_MachineAnalyse>());
            }
            message = "保存成功";
        ...
        public override int Insert(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Update<BT_MachineAnalyse>(newEntity.To<BT_MachineAnalyse>());
            }
