...
{
    public class Form_SM_T_DAYENERGY_EditDA : CommonBaseDA
    {
        public override string TableName
        {
            get { return "SM_T_DAYENERGY"; }
        }
        ...
        public override int Update(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Insert<SM_T_DAYENERGY>(newEntity.To<SM_T_DAYENERGY>());
            }
            message = "保存成功";
        ...
        public override int Insert(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Update<SM_T_DAYENERGY>(newEntity.To<SM_T_DAYENERGY>());
            }
