...
{
    public class Form_BT_DayProductAmount_EditDA : CommonBaseDA
    {
        public override string TableName
        {
            get { return "BT_DayProductAmount"; }
        }
        ...
        public override int Update(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Insert<BT_DayProductAmount>(newEntity.To<BT_DayProductAmount>());
            }
            message = "保存成功";
        ...
        public override int Insert(FormM form, DFDictionary entity, ref string message)
        {
            ...
            using (var db = Pub.DB)
            {
                db.Update<BT_DayProductAmount>(newEntity.To<BT_DayProductAmount>());
            }
