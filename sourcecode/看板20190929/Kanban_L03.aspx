<%@ Page Title="" Language="C#" MasterPageFile="~/KanbanSite.Master" AutoEventWireup="true" CodeBehind="Kanban_L03.aspx.cs" Inherits="Kanban.Kanban_L03" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-header">
        <div class="logo">
            ...
            <span style="font-size: 28px; color: white;" onclick="requestFullScreen();" id="span1">三号线炉温看板</span>
    ...
    <div class="row" style="display:none;" id="Energyrow1">
        <div class="col-md-6 col-sm-12">
    ...
    <script type="text/javascript" src="Scripts/L03MFUA.js"></script>
    <script type="text/javascript" src="Scripts/L03Energy1.js"></script>
    <script>
            ...
            $.getJSON('../Handler/ProcessHandler.ashx?action=l03lw', function (data) {
                if (data.hasError == true) {
                    ...
                    if (error === '') {
                        ...
                        $('#dMar').empty();
                        $('#dMar').append("<marquee width=600  direction = left align = middle > <font color='red' size='5'  face=楷体_GB2312><STRONG>" + error + "</STRONG></font></marquee >");
                    }
                    //initFirstLine();
