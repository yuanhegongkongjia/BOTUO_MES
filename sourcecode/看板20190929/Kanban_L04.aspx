...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" src="Scripts/L04LY.js?time=2"></script>
        <script type="text/javascript" src="Scripts/L04MFUA.js"></script>
    <script type="text/javascript" src="Scripts/L04Energy1.js"></script>
    <script type="text/javascript" src="Scripts/L04Energy2.js"></script>
    <script>
