    ...
    $.getJSON('../Handler/ProcessHandler.ashx?action=l04ua', function (data) {
        if (data.hasError === true) {
            ...
            if (chart1_MFUA.series.length == 0) {
                ...
                chart1_MFUA.yAxis[0].setExtremes(0, max + 200);
            ...
            if (chart2_MFUA.series.length == 0) {
                ...
                chart2_MFUA.yAxis[0].setExtremes(0, max + 200);
            ...
            if (chart3_MFUA.series.length == 0) {
                ...
                chart3_MFUA.yAxis[0].setExtremes(0, max + 200);
            ...
            if (chart4_MFUA.series.length === 0) {
                ...
                chart4_MFUA.yAxis[0].setExtremes(0, max + 200);
