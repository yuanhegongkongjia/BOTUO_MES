<%@ Page Title="" Language="C#" MasterPageFile="~/KanbanSite2.Master" AutoEventWireup="true" CodeBehind="L01LW2.aspx.cs" Inherits="Kanban.L01LW2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-header">
        <div class="logo">
            ...
            <span style="font-size: 28px; color: black;">一号线炉温看板</span>
            <%--  <h1 style="/*margin-left:600px;*/">一号线生产看板</h1>--%>
            <span style="color: black;" id="timeDiv"></span>
    ...
    <script>
        ...
        function prePage() {
            window.location.href = "L01Energe02.aspx";
        }
