<%@ Page Title="" Language="C#" MasterPageFile="~/KanbanSite.Master" AutoEventWireup="true" CodeBehind="L02LW.aspx.cs" Inherits="Kanban.L02LW" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <div class="page-header">
        <div class="logo">
            ...
            <span style="font-size: 28px; color: white;" onclick="requestFullScreen();">二号线炉温看板</span>
