<%@ Page Title="" Language="C#" MasterPageFile="~/KanbanSite.Master" AutoEventWireup="true" CodeBehind="L03MFUA.aspx.cs" Inherits="Kanban.L03MFUA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-header">
        <div class="logo">
            ...
            <span style="font-size: 28px; color: white;" onclick="requestFullScreen();">三号线MF电压/功率看板</span>
    ...
    <script>
         ...
         function nextPage() {
             window.location.href = "L03ENERGY1.aspx";
         }
         ...
         {
             $.getJSON('../Handler/ProcessHandler.ashx?action=l03ua', function (data) {
