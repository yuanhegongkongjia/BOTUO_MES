<%@ Page Title="" Language="C#" MasterPageFile="~/KanbanSite.Master" AutoEventWireup="true" CodeBehind="L02ENERGY1.aspx.cs" Inherits="Kanban.L02ENERGY1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-header">
        <div class="logo">
            ...
            <span style="font-size: 28px; color: white;" onclick="requestFullScreen();">二号线炉压/能源看板</span>
    ...
    <script>
        ...
        function nextPage() {
            window.location.href = "L02LW.aspx";
        }
